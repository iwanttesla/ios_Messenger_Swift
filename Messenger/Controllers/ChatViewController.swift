...
class ChatViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        messages.append(Message(sender: selfSender, messageId: "1", sentDate: Date(), kind: .text("Hello world messageHello world messageHello world messageHello world messageHello world message")))
